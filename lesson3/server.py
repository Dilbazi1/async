...
def main():
    ...
    def server_config():
        ...
        config_window.db_path.insert(config['SETTING']['Database_path'])
        config_window.db_file.insert(config['SETTING']['Database_file'])
        config_window.port.insert(config['SETTING']['Default_port'])
        config_window.ip.insert(config['SETTING']['Listen_Address'])
        config_window.save_btn.clicked.connect(save_server_config)

    def save_server_config():
        global confiq_window
        message=QMessageBox()
        config['SETTING']['Database_path']=confiq_window.db_path.text()
        config['SETTING']['Database_file']=confiq_window.db_file.text()
        try:
